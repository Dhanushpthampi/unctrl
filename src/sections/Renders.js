...
export default function Renders() {
  return (
    ...
    >
      ...
      >
        {/* Mobile video */}
        <source src="/assets/videos/controllerV.mp4" media="(max-width: 768px)" type="video/mp4" />
        {/* Desktop video */}
        <source src="/assets/videos/controller.mp4" media="(min-width: 769px)" type="video/mp4" />
      </video>
